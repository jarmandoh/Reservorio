  ...
  template: `
    ...
    >
      <div header class="flex flex-col items-center gap-3 text-center">
        @if (business()) {
          <div
            class="w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-soft"
      ...
      @if (!notFound()) {
        <div>
          ...
          <input
            id="pin"
            type="password"
            class="form-input text-center tracking-[0.4em] text-lg"
            inputmode="numeric"
            maxlength="8"
            formControlName="pin"
            placeholder="••••"
